...
WHERE(Start_date BETWEEN '20200625' AND '20200630') AND (end_date BETWEEN '20200625' AND '20200630') OR ('20200625' BETWEEN Start_date AND end_date) AND ('20200630' BETWEEN Start_date AND end_date)



SELECT * FROM reservation r
JOIN space s ON r.space_id = s.id
WHERE '202006116' < r.start_date 
...
JOIN space s on r.space_id = s.id
WHERE s.venue_id = 7
AND r.end_date >= '20200625' AND r.start_date <= '20200630')
